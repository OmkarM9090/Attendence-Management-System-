...
class AbsentStudentReport7 extends JFrame {
    AbsentStudentReport7(String subject, String date, String time, String username1, Object[][] absentStudents, String username) {
...
class Table8 extends JFrame {
    Table8(String username1, String username) {
        ...
        JLabel title = new JLabel("Attendance Sheet TE Div B", JLabel.CENTER);
        title.setFont(titleFont);
        ...
        searchButton.addActionListener(e -> {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendence", "root", "Sid@53da$e")) {
                String sql = "SELECT roll, name FROM teb WHERE roll = ?";
                try (PreparedStatement pst = con.prepareStatement(sql)) {
                    ...
                    new AbsentStudentReport7(subject, date, time, username1, absentStudents, username);
                }
            } catch (Exception ex) {
