...
class AbsentStudentReport2 extends JFrame {
    AbsentStudentReport2(String subject, String date, String time, String username1, Object[][] absentStudents, String username) {
...
class Table3 extends JFrame {
    Table3(String username1,String username) {
        ...
        JLabel title = new JLabel("Attendance Sheet", JLabel.CENTER);
        title.setFont(titleFont);
        ...
        searchButton.addActionListener(e -> {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendence", "root", "Sid@53da$e")) {
                String sql = "SELECT roll, name FROM fec WHERE roll = ?";
                try (PreparedStatement pst = con.prepareStatement(sql)) {
                    ...
                    new AbsentStudentReport2(subject, date, time, username1, absentStudents, username );
                }
            } catch (Exception ex) {
