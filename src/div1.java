...
class Div1 extends JFrame {
    Div1(String username) {
...
//        int windowHeight = screenSize.height;
        ...
        A.setBounds(380,150,250,50);
        B.setBounds(380,250,250,50);
        C.setBounds(380,350,250,50);
        bButton.setBounds(80,520,200,50);
