...
class AbsentStudentReport5 extends JFrame {
    AbsentStudentReport5(String subject, String date, String time, String username1, Object[][] absentStudents, String username) {
...
class Table6 extends JFrame {
    Table6(String username1, String username) {
        ...
        JLabel title = new JLabel("Attendance Sheet SE Div C", JLabel.CENTER);
        title.setFont(titleFont);
        ...
        searchButton.addActionListener(e -> {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendence", "root", "Sid@53da$e")) {
                String sql = "SELECT roll, name FROM sec WHERE roll = ?";
                try (PreparedStatement pst = con.prepareStatement(sql)) {
                    ...
                    new AbsentStudentReport5(subject, date, time, username1, absentStudents,username);
                }
            } catch (Exception ex) {
