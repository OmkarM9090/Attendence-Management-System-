...
class AbsentStudentReport10 extends JFrame {
    AbsentStudentReport10(String subject, String date, String time, String username1, Object[][] absentStudents, String username) {
...
class Table11 extends JFrame {
    Table11(String username1, String username) {
        ...
        JLabel title = new JLabel("Attendance Sheet BE Div B", JLabel.CENTER);
        title.setFont(titleFont);
        ...
        searchButton.addActionListener(e -> {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendence", "root", "Sid@53da$e")) {
                String sql = "SELECT roll, name FROM beb WHERE roll = ?";
                try (PreparedStatement pst = con.prepareStatement(sql)) {
                    ...
                    new AbsentStudentReport10(subject, date, time, username1, absentStudents,username);
                }
            } catch (Exception ex) {
