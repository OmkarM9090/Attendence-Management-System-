...
class AbsentStudentReport3 extends JFrame {
    AbsentStudentReport3(String subject, String date, String time, String username1, Object[][] absentStudents, String username) {
...
class Table4 extends JFrame {
    Table4(String username1, String username) {
        ...
        JLabel title = new JLabel("Attendance Sheet SE Div A", JLabel.CENTER);
        title.setFont(titleFont);
        ...
        searchButton.addActionListener(e -> {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendence", "root", "Sid@53da$e")) {
                String sql = "SELECT roll, name FROM sea WHERE roll = ?";
                try (PreparedStatement pst = con.prepareStatement(sql)) {
                    ...
                    new AbsentStudentReport3(subject, date, time, username1, absentStudents,username);
                }
            } catch (Exception ex) {
