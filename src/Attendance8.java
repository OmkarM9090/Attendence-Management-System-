...
class AbsentStudentReport8 extends JFrame {
    AbsentStudentReport8(String subject, String date, String time, String username1, Object[][] absentStudents , String username) {
...
class Table9 extends JFrame {
    Table9(String username1 , String username) {
        ...
        JLabel title = new JLabel("Attendance Sheet TE Div C", JLabel.CENTER);
        title.setFont(titleFont);
        ...
        searchButton.addActionListener(e -> {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendence", "root", "Sid@53da$e")) {
                String sql = "SELECT roll, name FROM tec WHERE roll = ?";
                try (PreparedStatement pst = con.prepareStatement(sql)) {
                    ...
                    new AbsentStudentReport8(subject, date, time, username1, absentStudents, username);
                }
            } catch (Exception ex) {
