...
class AbsentStudentReport1 extends JFrame {
    AbsentStudentReport1(String subject, String date, String time, String username1, Object[][] absentStudents, String username) {
...
class Table2 extends JFrame {
    Table2(String username1, String username) {
        ...
        JLabel title = new JLabel("Attendance Sheet FE Div B", JLabel.CENTER);
        title.setFont(titleFont);
        ...
        searchButton.addActionListener(e -> {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendence", "root", "Sid@53da$e")) {
                ...
                try (PreparedStatement pst = con.prepareStatement(sql)) {
                    ...
                    new AbsentStudentReport1(subject, date, time, username1, absentStudents, username);
                }
            } catch (Exception ex) {
