...
class AbsentStudentReport9 extends JFrame {
    AbsentStudentReport9(String subject, String date, String time, String username1, Object[][] absentStudents, String username) {
...
class Table10 extends JFrame {
    Table10(String username1, String username) {
        ...
        JLabel title = new JLabel("Attendance Sheet BE Div A", JLabel.CENTER);
        title.setFont(titleFont);
        ...
        searchButton.addActionListener(e -> {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendence", "root", "Sid@53da$e")) {
                String sql = "SELECT roll, name FROM bea WHERE roll = ?";
                try (PreparedStatement pst = con.prepareStatement(sql)) {
                    ...
                    new AbsentStudentReport9(subject, date, time, username1, absentStudents, username);
                }
            } catch (Exception ex) {
